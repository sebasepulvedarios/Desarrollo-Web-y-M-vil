<html>
    <head>
        <title>Servicios - Librería Épica</title>
        <meta charset="utf-8">
    ...
    <body class="d-flex flex-column min-vh-100">
        ...
        <div class="container-fluid bg-light flex-grow-1 p-5 text-center">
            <h2 class="text-primary">Servicios del Gremio</h2>
            <ul class="list-unstyled">
                <li>📖 Club de lectura mensual de Alta Fantasía</li>
                <li>📦 Envíos en pergamino a todo el reino</li>
                <li>⚔️ Torneos de conocimiento literario</li>
            </ul>
