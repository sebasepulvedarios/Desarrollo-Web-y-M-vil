<html>
    <head>
        <title>Catálogo - Librería Épica</title>
        <meta charset="utf-8">
    ...
    <body class="d-flex flex-column min-vh-100">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="productos.php">Libros Mágicos</a></li>
        ...
        <div class="container-fluid bg-light flex-grow-1 p-5 text-center">
            ...
            <p>Sagas completas, ediciones ilustradas y mapas en tela de los mejores reinos.</p>
